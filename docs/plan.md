...
- [x] **Auto-declare winner**: When only one active player remains (one eliminated at point limit), auto-show winner or prompt to end—user currently must tap "End Game" manually.
